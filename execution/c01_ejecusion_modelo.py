...
feature_test_selected = joblib.load(f'files/datasets/intermediate/a05_feature_test_selected{entrenamiento_sufix}.pkl') # TODO Lo ideal es leer los datos enteros con la parte del preproceso que hace sentido para datos nuevos. Acá estoy leyendo train solo para hacerlo rápido y demostrar que funciona, pero lo ideal sería tener un dataset distinto (con datos de un nuevo periodo, por ejemplo) y aplicar el modelo a ese dataset, luego de haberle hecho las modificaciones necesarias.
